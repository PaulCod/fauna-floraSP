    ...
    <div className="relative w-full h-full">
      <div className="absolute top-6 left-6 z-[1000] flex flex-col gap-4">
        ...
        <div className="bg-white/95 backdrop-blur-md p-4 rounded-xl shadow-xl border border-gray-200 w-48">
          ...
          <div className="flex flex-col gap-2">
            <a 
              href="https://docs.google.com/forms/d/e/1FAIpQLSdsV__-VxwzfY_11i1evXXCTvSIrdV4d-SLsbw7n1KaDGGs6w/viewform?usp=publish-editor" 
              target="_blank" 
              className="text-sm font-medium text-gray-600 hover:text-blue-600 flex items-center gap-2 transition"
            >
              <span>💬</span> Dê seu feedback
            </a>
            <a 
        ...
        {filteredSpecies.map((s) => (
          ...
          >
            <Popup minWidth={260} maxWidth={260} className="custom-popup">
              <div className="overflow-hidden rounded-t-lg relative w-full h-40 bg-gray-50 border-bottom border-gray-100">
                {s.imageUrl ? (
                  <Image 
                    src={s.imageUrl} 
                    alt={s.name} 
              ...
              <div className="p-4">
                <div className="flex flex-col gap-1 mb-2">
                  <div className="flex justify-between items-start gap-2">
                    ...
                    <span className={`text-[8px] px-2 py-0.5 rounded-full text-white font-black uppercase whitespace-nowrap shadow-sm ${
